		    ...
		    <fieldset>
		    	<div id="detali-rezervacija">
			        <div class="grid-6-12">
				        <p class="datum-izdavanje">Резервација број <b><?php echo $detail['DOK_ID']?></b></p>
					...
					<div class="grid-6-12">
						<p class="datum-izdavanje">Период на изнајмување од <b><?php echo date("d-m-Y", strtotime($detail['DATUM_POC']));?></b> до <b><?php echo date("d-m-Y", strtotime($detail['DATUM_KRAJ']));?></b></p>
					</div>
		        	...
		        	<div style="width:100%">
						...
						<div>
					        ...
					        <div class="grid-3-12">
						        ...
						        <input id="embg_data" name="EMBG_DATUM" type="text" value="">
				...
				<fieldset>
			        ...
			        <div style="width:60%">
			            ...
			            <div class="grid-6-12">
							...
							<input id="predvideno-vrakane" name="PREDV_DATUM_KRAJ" type="text" value="<?php echo date("d-m-Y H:i", strtotime($detail['DATUM_KRAJ']))?>">
			            </div>
						<div class="grid-6-12">
			                <label for="predvideno-mesto-vrakane">Место</label>
							<input id="predvideno-mesto-vrakane" name="MESTO_PREDV_KRAJ" type="text" value="<?php echo $detail['MESTO_KRAJ']?>">
			            </div>
			        ...
			        <div style="width:100%">
			        	<div class="grid-2-12">
				        	...
				        	<input id="vkupno-denovi" name="DENOVI" type="text" value="<?php echo $detail['DENOVI']?>">
			        	</div>
			        	<div class="grid-3-12">
			        ...
			        <div id="tabs2">
								...
								<div style="width:100%;float:right">
									<div style="border-bottom:1px solid">
										...
										<div class="grid-3-12">
						                    ...
						                    <select name="GORIVO_POC" style="font-size: 1.4em">
						                    	<option value=""></option>
						                    	<?php foreach ($gorivo as $g):?>						                    	
							                    <option value="<?php echo $g['RV_LOW_VALUE'];?>"><?php echo $g['RV_MEANING'];?></option>
												<?php endforeach;?>
						               	 	</select>
						               	 </div>
						               	 <div class="grid-3-12">
						               	 	<label>При враќање</label>				
						                    <select name="GORIVO_KRAJ" style="font-size: 1.4em">
						                    	<option value=""></option>
								                 <?php foreach ($gorivo as $g):?>						                    	
							                    <option value="<?php echo $g['RV_LOW_VALUE'];?>"><?php echo $g['RV_MEANING'];?></option>
												<?php endforeach;?>
									...
									<div class="grid-3-12">
										<label>Депозит</label>				
					                    <select id="depozit" style="font-size: 1.4em">
					                    	<option value=""></option>
							...
							<div id="tab-3">
								<div class="grid-4-12">
				                	<ul class="formee-list">
				                		<li><input name="OPREMA_GPS" type="checkbox"> <label>GPS</label></li>
					                    <li><input name="OPREMA_DSEDISTE" type="checkbox"> <label>Детско седиште</label></li>
					                   </li>
				                	</ul>
				                </div>
							</div>
